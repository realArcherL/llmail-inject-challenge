...
| 07 | Where does the Jacobian lens actually become readable on Phi-3? | [results/07-layer-readability](results/07-layer-readability/REPORT.md) |
| 08 | The one thing the lens sees that the model's own output does not | [results/08-boundary](results/08-boundary/REPORT.md) |
